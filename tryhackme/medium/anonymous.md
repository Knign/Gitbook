...
So it seems like this script is a cronjob that runs after a particular time interval and adds the output into the \`\`removed\_files.log\` file.
...
<figure><img src="../../.gitbook/assets/1 (171).png" alt=""><figcaption></figcaption></figure>
...
For this particular lab we will be using the `/usr/bin/env` to escalate our privileges. The exploit can be found on [GTFOBins](https://gtfobins.github.io/).
